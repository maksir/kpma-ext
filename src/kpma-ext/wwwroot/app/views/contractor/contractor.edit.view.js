...
var ContractorEdit = (function () {
    function ContractorEdit(contrSrv, route) {
    ...
    ContractorEdit.prototype.ngOnInit = function () {
        ...
        this.contrSrv.getContractor(this.contractorId).subscribe(function (res) { return _this.model = res; }, function (err) { return console.log(err); });
    };
    ContractorEdit = __decorate([
        ...
        __metadata('design:paramtypes', [contractor_service_1.ContractorService, router_1.ActivatedRoute])
    ], ContractorEdit);
